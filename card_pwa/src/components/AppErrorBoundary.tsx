    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen flex items-center justify-center px-4" style={{ background: 'var(--theme-background, #09090f)' }}>
          <div className="w-full max-w-lg rounded-[2.5rem] border border-white/15 bg-slate-950/90 p-8 text-center text-white transition-all duration-300 ease-out">
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-2xl font-black text-white transition-all duration-300 ease-out active:scale-95"
