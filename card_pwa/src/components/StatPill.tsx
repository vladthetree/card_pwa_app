...
export function StatPill({
  ...
  const className = `w-full flex min-h-[4.25rem] flex-col items-center justify-center rounded-ds-2xl border border-[#18181b] bg-[#0c0c0c] px-2 py-2.5 text-left shadow-card sm:min-h-[8.5rem] sm:px-4 sm:py-10 ${interactive ? 'cursor-pointer hover:border-[#3f3f46] hover:bg-[#111] active:scale-[0.99] transition-all duration-200 ease-out' : 'cursor-default'}`
  const content = (
    <>
