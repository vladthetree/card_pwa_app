...
export function HomeDailyQuestTile({
  ...
  return (
    <motion.section
      ...
      className="rounded-[14px] border border-emerald-500/25 bg-[#090d0b] p-3 shadow-card sm:p-4"
    >
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-0.5 truncate font-mono text-lg font-bold text-[#f0ede8] sm:text-xl">
      ...
      <div className="mt-3 flex items-stretch gap-2">
        <button
          ...
          className="flex min-h-[48px] flex-1 items-center justify-center gap-2 rounded-[12px] border border-emerald-400/30 bg-emerald-400/85 px-4 font-mono text-[14px] font-semibold text-[#04140b] transition-all duration-150 hover:bg-emerald-300 active:scale-[0.98] disabled:cursor-default disabled:opacity-40"
        >
          {starting
        ...
        <button
          type="button"
          onClick={onShowDecks}
          className="flex min-h-[48px] items-center justify-center gap-2 rounded-[12px] border border-[#1f1f23] bg-[#0c0c0c] px-4 font-mono text-[13px] text-white/75 transition-colors hover:border-[#3f3f46] hover:text-white active:scale-[0.98]"
        >
