...
const THEME_PAIRS = {
  ...
  'newsprintDark (Newsprint Dark)': [
    { name: 'OLED canvas/text', bg: '#000000', fg: '#E8E8E3', min: AA_NORMAL },
    { name: 'inset floor/text', bg: '#141413', fg: '#E8E8E3', min: AA_NORMAL },
    { name: 'card/text', bg: '#1E1E1C', fg: '#E8E8E3', min: AA_NORMAL },
    { name: 'panel(divider-dark)/text', bg: '#2C2C29', fg: '#E8E8E3', min: AA_NORMAL },
    { name: 'OLED canvas/text-secondary', bg: '#000000', fg: '#C9C9C2', min: AA_NORMAL },
    { name: 'OLED canvas/text-muted', bg: '#000000', fg: '#A3A39C', min: AA_NORMAL },
    { name: 'OLED canvas/subtle', bg: '#000000', fg: '#8A8A83', min: AA_LARGE },
    { name: 'accent(red)/OLED canvas — Akzenttext auf Fond', bg: '#000000', fg: '#FF6166', min: AA_NORMAL },
